      ...
      <section className="py-16 sm:py-24 bg-gradient-to-br from-primary via-primary to-black relative overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row items-center gap-10 lg:gap-16">
            ...
            >
              <Link href="/apply">
                <Button size="lg" className="group w-full lg:w-auto bg-accent hover:bg-white text-primary px-6 sm:px-14 py-6 sm:py-10 text-sm sm:text-xl rounded-none font-black uppercase tracking-wide sm:tracking-widest transition-all duration-500 hover:scale-105 active:scale-95 shadow-[0_20px_60px_rgba(0,0,0,0.4)] border-0">
                  <span className="flex items-center justify-center gap-2 sm:gap-3 text-center leading-snug">
                    ...
                    <span>Apply For Medical Fundraising</span>
