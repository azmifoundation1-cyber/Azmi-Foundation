      ...
      <div className="max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-8 py-4 lg:py-12">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 lg:gap-12 items-start">
          ...
          <div className="lg:col-span-3 space-y-4 lg:space-y-8">
            ...
            {/* Share Section — Copy Link only */}
            <button onClick={handleCopy} className="w-full flex items-center justify-center gap-2 px-4 py-3 border-2 border-gray-200 text-gray-600 text-sm font-black uppercase tracking-widest rounded-lg hover:border-primary hover:text-primary transition-colors">
