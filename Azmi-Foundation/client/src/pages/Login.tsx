...
export default function Login() {
  ...
  const { data: googleConfig } = useQuery<{ available: boolean }>({
    queryKey: ["/api/auth/google/available"],
    queryFn: () => fetch("/api/auth/google/available").then(r => r.json()),
    staleTime: 300000,
  });
  ...
  const googleFailed = search.includes("error=google_failed");
        ...
        <div className="w-full max-w-md">
          ...
          <a href="/api/auth/google" className="block mb-4">
            <Button
              type="button"
              variant="outline"
              className="w-full h-12 border border-gray-300 hover:bg-gray-50 font-semibold text-sm flex items-center justify-center gap-3 rounded-lg shadow-sm transition-all"
            >
              <GoogleIcon />
          ...
          {googleFailed && (
            <div className="flex items-center gap-2 p-3 mb-4 bg-red-50 border border-red-200 rounded-lg text-red-700 text-sm">
              ...
              <span>Google sign-in failed. Please try email login below.</span>
            </div>
          )}
          ...
          <div className="relative my-5">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-white px-3 text-gray-400 tracking-widest">or sign in with email</span>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className="pl-10 h-11 border-gray-200 focus:border-primary focus:ring-primary rounded-lg"
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className="pl-10 pr-10 h-11 border-gray-200 focus:border-primary focus:ring-primary rounded-lg"
            ...
            <Button
              ...
              className="w-full h-11 bg-primary hover:bg-primary/90 text-white font-bold uppercase tracking-widest text-sm transition-all rounded-lg"
            >
              {login.isPending ? (
