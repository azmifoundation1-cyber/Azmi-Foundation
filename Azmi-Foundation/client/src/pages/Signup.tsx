    ...
    <div className="min-h-screen flex">
      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-white overflow-y-auto">
        <div className="w-full max-w-md py-8">
          ...
          {/* Google OAuth button */}
          <a href="/api/auth/google" className="block mb-5">
            <Button
              type="button"
              variant="outline"
          ...
          <div className="relative mb-5">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-white px-3 text-gray-400 tracking-widest">or sign up with email</span>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <Button
              ...
              className="w-full h-11 bg-primary hover:bg-primary/90 text-white font-bold uppercase tracking-widest text-sm transition-all mt-2 rounded-lg"
            >
              {signup.isPending ? (
